/*
  ...
  OB - added trigger on getPage to listen to to rerender dashboard
*/
  ...
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    _makeComparator: function (sortKey, order, sortValue) {
      ...
      return function (left, right) { // WB - added the '.toLowerCase()' to fix sorts that were incorrect due to the prevalence of lowercase characters
